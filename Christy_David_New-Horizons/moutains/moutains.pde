/*
WARNING: This is VERY SLOW and will cause computer to be annoying if left open with the non-black forground.
*/
...
float x = 0;
int y = height/2;
ArrayList<Integer> state = new ArrayList<Integer>(width);
...
void draw(){
  ...
  if(!done){
    ...
    //I need to scan the vaules of the list and decide if there is a 
